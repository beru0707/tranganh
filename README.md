...
<head>
    ...
    <title>Báo Tường - Mùa Xuân 2025</title>
    <style>
        body {font-family: Arial, sans-serif; margin: 0;padding: 0;background-color: #f2f2f2;color: #333;}
        header {background-color: #2d8b53;color: white;text-align: center;padding: 20px 0;}
        header h1 {margin: 0;}
        ...
        .article{background-color: white;margin-bottom: 20px;padding: 20px;border-radius:8px;box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);}
        .article img{ max-width: 100%;border-radius: 8px;}
        .article h2 {color: #2d8b53;}
        footer {text-align: center; background-color: #2d8b53; padding: 10px; margin-top: 20px; color: white; font-weight: bold;}
        .footer-links a 
        {color: white;text-decoration: none; padding: 0 10px;}
...
<body>
    ...
    <header>
        <h1>Báo Tường - Mùa Xuân 2025</h1>
        <p>Chào đón mùa xuân 2025 cùng những hoạt động và nhiều điều mới.</p>
    </header>

    <div class="navbar">
        <a href="#home">Trang chủ</a>
        <a href="#events"> Những ngày cuối năm </a>
        <a href="#news">Những món ăn truyền thống</a>
        <a href="#contact">Những phong tục cổ truyền</a>
        <a href="#end">Chào đón năm mới </a>
    </div>
    ...
    <div class="content">
        <section id="home">
            <div class="article">
                ...
                <img src="https://scontent.fdad3-5.fna.fbcdn.net/v/t39.30808-6/473568118_3406960556104488_2717152780966980611_n.png?stp=dst-jpg_tt6&_nc_cat=1&ccb=1-7&_nc_sid=2285d6&_nc_ohc=Teg7Ss25plgQ7kNvgHVYusK&_nc_oc=AdjnFe6RQ8LYwzD4y6wNk5U76iYDRFcDkhRBdNpstevf0FLSBy6KYj-1YVd2StQR3Tk&_nc_zt=23&_nc_ht=scontent.fdad3-5.fna&_nc_gid=A5ODi8kxtcemd952rj5MbNj&oh=00_AYBICk4MyGoHB-JTyvwoOmCFz7woy9V_RVTwvCB8y4hm8A&oe=67B462D4" alt="Mùa xuân 2025">
